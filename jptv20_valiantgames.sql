...
--
-- Хост: 127.0.0.1
-- Время создания: Мар 15 2023 г., 09:07
...
CREATE TABLE `companies` (
  ...
  `companyTitle` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `games` (`id`, `title`, `publishYear`, `companyId`, `poster`, `price`, `categoryId`, `g_created_at`, `updated_at`) VALUES
...
(14, 'Fallout 4', 2015, 16, 'https://m.media-amazon.com/images/W/IMAGERENDERING_521856-T1/images/I/913m4BOW-NL.jpg', 19.99, 16, '2023-02-28 05:19:28', '2023-02-28 05:19:28'),
(15, 'Fallout 76', 2020, 16, 'https://d25-a.sdn.cz/d_25/c_img_H_Eg/p3ZBwm6.jpeg', 39.99, 16, '2023-02-28 05:21:07', '2023-02-28 05:21:07'),
...
(35, 'Dishonored: The Brigmore Witches', 2013, 17, 'https://cdna.artstation.com/p/assets/covers/images/006/401/026/large/marc-bidoul-dishonored-the-brigmore-witches-logo.jpg?1498311866', 4.99, 8, '2023-02-28 06:18:38', '2023-02-28 06:18:38'),
...
CREATE TABLE `game_user` (
  ...
  `status` enum('WISHED','BUY') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'WISHED',
  `price` float NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `users` (
  ...
  `avatar` varchar(255) COLLATE utf8_unicode_ci DEFAULT 'https://w7.pngwing.com/pngs/178/595/png-transparent-user-profile-computer-icons-login-user-avatars-thumbnail.png',
  `role` enum('USER','MODERATOR','ADMIN') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'USER',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
